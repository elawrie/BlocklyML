...
Blockly.Python['print_data'] = function(block) {
    var readCsvBlock = block.getInputTargetBlock('URL');
...
Blockly.Python['scatterplot'] = function(block) {
    ...
    var code = `from plotnine import ggplot, aes, geom_point, theme_gray, theme_bw, theme_linedraw, theme_light, theme_dark, theme_minimal, theme_classic, theme_void\n${df}\n(ggplot(df, aes(x = '${x}', y = '${y}'${z == "none" ? '' : `, color = '${z}'`})) + geom_point() + theme_${theme}())`.replace(/^\s+/gm, '');
